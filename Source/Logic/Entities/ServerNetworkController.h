 ...
 *   should inherit from the {ServerNetworkController} class, and get their entity to
 *   do stuff by using the addEvent method.
 *
 *   whenever the {ServerNetworkController::addEvent} function is called, it will get its
