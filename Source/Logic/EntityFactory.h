...
class EntityFactory
{
    ...
    private:
        ...
        id_resource gkSprite, minionSprite, projSprite, vesselSprite, maskSprite, spearSprite, structImage;
        SGO gkSGO, minionSGO, projSGO, vesselSGO, maskSGO, spearSGO, structSprite;
};
